...
public class FilePreviewUtil {
     ...
     */
    private static File converterFile(File inputFile, String outputFilePath, String inputFilePath, OfficeDocumentConverter converter) throws OfficeException {
     ...
     * @return  对应的pdf文件
     */
    private static File office2pdf(String inputFilePath) throws OfficeException {
